...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    _localDatastore = [LocalDatastoreService new];
...
{
    [self.localDatastore saveCurrentContext];
}
...
//    // The directory the application uses to store the Core Data store file. This code uses a directory named "FedorX.Planets" in the application's documents directory.
